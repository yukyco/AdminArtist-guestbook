...
<html lang="en">
  <head>
    ...
    <title>Dashboard ArtistAdmin Message Board</title>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">Message List | Thank You <3 Your post is here.</a>
        </div>
      </div>
       <div class="col-md-3">
<h3>LATEST POST</h3>
...
<a href="guest_input.php"><font color="white" size="3">Go To Entry Page</font></a>
</div>
