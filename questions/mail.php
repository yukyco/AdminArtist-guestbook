...
$site_top = "http://yukycohamabe.ciao.jp/AdminArtist/index.html";

// 管理者メールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "info@yukycohamabe.ciao.jp";
...
$thanksPage = "http://yukycohamabe.ciao.jp/AdminArtist/thanks.html";
...
この度はご興味・ご関心をお寄せ下さいましてありがとうございます。

数日以内に担当者からご連絡させて頂きますので、しばらくお待ちください。
...
URL: http://yukycohamabe.ciao.jp/AdminArtist/
...
<?php }else{ ?>
<h3>Confirmation</h3>
<p align="center">If your message is ok, please push the button.</p>
...
function copyright(){
	echo '<a style="display:block;text-align:center;margin:15px 0;font-size:11px;color:#aaa;text-decoration:none" href="http://yukycohamabe.ciao.jp/" target="_blank"></a>';
}
//----------------------------------------------------------------------
//  関数定義(END)
//----------------------------------------------------------------------
